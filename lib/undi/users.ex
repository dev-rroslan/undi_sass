defmodule Undi.Users do
  ...
  alias Undi.Users.{User, UserToken, UserNotifier}
  ...
  defp create_personal_account({:ok, user} = result) do
    {:ok, account} =
      Undi.Accounts.create_account(
        user, %{personal: true, name: "Personal Account"}
      )

    Undi.Accounts.create_membership(account, user, %{role: :owner})
