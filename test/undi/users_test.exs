defmodule Undi.UsersTest do
  use Undi.DataCase

  alias Undi.Users

  import Undi.UsersFixtures
  alias Undi.Users.{User, UserToken}
  ...
  describe "register_user/1" do
    ...
    test "creates the personal account" do
      ...
      assert %Undi.Accounts.Account{personal: true} = user.personal_account
      assert [%Undi.Accounts.Membership{role: :owner}] = user.memberships
    end
  end
