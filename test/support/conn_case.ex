defmodule UndiWeb.ConnCase do
  ...
  def register_and_log_in_user(%{conn: conn}) do
    user = Undi.UsersFixtures.user_fixture()
  ...
  def log_in_user(conn, user) do
    token = Undi.Users.generate_user_session_token(user)
  ...
  def register_and_log_in_admin(%{conn: conn}) do
    admin = Undi.AdminsFixtures.admin_fixture()
  ...
  def log_in_admin(conn, admin) do
    conn
    |> Phoenix.ConnTest.init_test_session(%{})
    |> Undi.Admins.Guardian.Plug.sign_in(admin, %{}, key: :admin)
  end
end
